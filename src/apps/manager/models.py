...
class Storage(models.Model):
    ...
    id_product = models.ForeignKey("member.Product", on_delete=models.PROTECT, null=False)
...
class Debiting(models.Model):
    ...
    id_delivery = models.ForeignKey("member.Delivery", on_delete=models.PROTECT, null=False)