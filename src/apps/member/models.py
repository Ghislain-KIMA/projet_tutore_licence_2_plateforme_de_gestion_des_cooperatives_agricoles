...
class Inject_Prod(models.Model):
    ...
    id_user = models.ForeignKey("customer.User", on_delete=models.PROTECT, null=False)
...
class Having_Function(models.Model):
    id_user = models.ForeignKey("customer.User", on_delete=models.CASCADE, null=False)
